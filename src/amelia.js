...
重要：成员的游戏名（player_id / name）必须原样引用，不得删改任何部分。例如「地平线『No.188』孤独与风」应完整输出，禁止缩写为「孤独与风」。
概念区分：「佩戴舷号」指成员的游戏名中包含舷号字段（如名字里含有 No.XXX 字样），与数据库 hull_number 列无关。查询谁佩戴/未佩戴舷号时，应检查成员游戏名是否含有 No.\d+ 模式。
